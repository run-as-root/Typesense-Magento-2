...
class QueryMerchandisingRepository implements QueryMerchandisingRepositoryInterface
{
    public function __construct(
        private readonly QueryMerchandisingFactory $factory,
        private readonly QueryMerchandisingResource $resource,
